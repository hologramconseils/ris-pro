        ...
        <section>
          ...
          <div className="text-muted flex flex-col gap-2">
            ...
            <p className="text-xs mt-2">
              {LABELS.BRAND_NAME} se réserve le droit de modifier ses conditions générales de vente à tout moment, notamment en ce qui concerne les tarifs ou l’évolution vers un modèle d’abonnement mensuel résiliable à tout moment, sous réserve d’une information préalable des clients.
            </p>
          </div>
        </section>
