...
## 1. La LURA (Liquidation Unique des Régimes Alignés)
Mise en place en 2017, la LURA s'applique aux assurés nés après 1953 ayant cotisé à au moins deux des régimes dits "alignés" :
- Le Régime Général des salariés (CNAV)
- La Mutualité Sociale Agricole (MSA salariés)
- La Sécurité Sociale des Indépendants (SSI - ex RSI pour les artisans/commerçants)

### Principe de calcul
- **Un seul calcul de pension** est effectué comme si l'assuré n'avait relevé que d'un seul régime.
- **Salaire Annuel Moyen (SAM) :** Calculé sur les 25 meilleures années **tous régimes alignés confondus**.
- **Plafond annuel :** La somme des salaires validés sur une même année (salarié + indépendant) est écrêtée et ne peut dépasser le Plafond Annuel de la Sécurité Sociale (PASS) en vigueur cette année-là.
- **Trimestres :** On ne peut valider que 4 trimestres maximum par an, même en cas de double cotisation simultanée.

## 2. Régimes hors LURA
Si l'assuré a cotisé à un régime non aligné (Fonction publique, Professions Libérales CNAVPL, Régimes spéciaux), la LURA ne s'applique pas pour ces régimes.

### Règle des pensions multiples (Liquidation séparée)
- Chaque régime (aligné vs non-aligné) liquide sa propre pension de manière indépendante.
...
- **Taux plein :** Le droit au taux plein (âge ou durée d'assurance) s'apprécie en prenant en compte **la totalité des trimestres validés tous régimes confondus**. Un trimestre cotisé à la CNAVPL compte pour atteindre la durée d'assurance requise au Régime Général, et inversement.
    ...
    Voici les nouvelles conditions pour l'âge légal de départ et la durée d'assurance requise pour un taux plein, applicables aux pensions prenant effet à partir du 1er septembre 2026, suite à la "suspension" partielle du calendrier initial de la réforme de 2023 par la LFSS 2026:
...
Le dispositif de retraite progressive, permettant de travailler à temps partiel tout en percevant une fraction de sa retraite, est accessible à partir d'un certain âge, généralement deux ans avant l'âge légal de départ à la retraite, sous conditions de durée d'assurance. Les conditions précises sont définies par la législation en vigueur et peuvent varier selon les situations individuelles.

### Dispositif de Cumul Emploi-Retraite
Le dispositif de cumul emploi-retraite a été modifié par la réforme des retraites de 2023. Pour bénéficier du cumul emploi-retraite intégral (sans limitation de revenus), l'assuré doit avoir liquidé l'ensemble de ses pensions de retraite (de base et complémentaires). Des règles d'écrêtement peuvent s'appliquer à la pension en fonction des revenus d'activité et de l'âge de l'assuré dans le cadre du cumul emploi-retraite plafonné.
