...
- **Évolution post-2023** : Extension de la pension de réversion aux orphelins dans le régime général et le régime Agirc-Arrco, sous certaines conditions (auparavant, seuls les orphelins de fonctionnaires pouvaient en bénéficier).
- **Simplification administrative (depuis mars 2026)** : L'Assurance retraite envoie des formulaires de demande de réversion préremplis, et il est possible de réaliser une demande de réversion en ligne via le site Service Public.