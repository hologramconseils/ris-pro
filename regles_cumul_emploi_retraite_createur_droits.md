...
*   **À partir de 67 ans (âge du taux plein automatique) :** L'assuré pourra cumuler intégralement ses pensions de retraite et ses revenus d'activité et de remplacement sans plafond. Les cotisations versées dans le cadre de cette activité pourront continuer à permettre l'acquisition de nouveaux droits à retraite. Le délai de carence de 6 mois en cas de reprise d'activité chez le dernier employeur sera supprimé. Il est également prévu que le plafond de 5% du PASS pour la seconde pension de base soit supprimé pour les pensions prenant effet à compter de cette date.
