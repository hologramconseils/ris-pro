...
Ces règles ont été intégrées le 06 Août 2026 au sein du fichier `backend/services/rules_engine.py` de l'application RIS Pro.
...
Les informations de ce document ont été mises à jour le 06 août 2026 pour refléter les modifications apportées par la Loi de financement de la Sécurité sociale pour 2026 (LFSS 2026) et ses décrets et circulaires d'application, notamment :
